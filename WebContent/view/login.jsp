...
<title>登录|健身房会员管理系统</title>
<meta name="keywords" content="健身房会员管理系统">
</head>
<body>

<div class="header" style="padding: 0;">
	<h2 style="color: white; width: 400px; height: 60px; line-height: 60px; margin: 0 0 0 30px; padding: 0;">健身房会员管理系统</h2>
</div>
    ...
    <form id="form" class="form form-horizontal" method="post">
      ...
      <div class="mt-20 skin-minimal" style="text-align: center;">
		<div class="radio-box">
			...
			<label for="radio-1">会员</label>
		</div>
		<div class="radio-box">
			<input type="radio" id="radio-3" name="type" value="3" />
			<label for="radio-2">教练</label>
		</div>
		<div class="radio-box">
