	...
	$(function() {	
	        ...
	        columns: [[  
				{field:'chk',checkbox: true,width:50},
 		        ...
 		        {field:'qq',title:'QQ',width:150},
 		       	{field:'clazz_id',title:'项目',width:150, 
	    ...
	    $("#delete").click(function(){
        	...
        	if(selectLength == 0){
            	...
            	$.messager.confirm("消息提醒", "将删除与教练相关的所有数据，确认继续？", function(r){
            		if(r){
            			$.ajax({
							type: "post",
...
<body>
	...
	<div id="toolbar">
		...
		<div style="margin-left: 10px;margin-top:4px;" >项目：<input id="clazzList" class="easyui-textbox" name="clazz" />
