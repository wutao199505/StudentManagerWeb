	    ...
	    $('#dataList').datagrid({ 
	        ...
	        columns: [[  
				{field:'chk',checkbox: true,width:50},
 		        ...
 		        {field:'studentId',title:'姓名',width:200,
    	...
    	<form id="addForm" method="post">
	    	<table cellpadding="8" >
	    		<tr>
	    			...
	    			<td colspan="3">
	    				<input id="add_studentList" style="width: 200px; height: 30px;" class="easyui-textbox" name="studentid" data-options="required:true, missingMessage:'请选择会员'" />
	    			</td>
