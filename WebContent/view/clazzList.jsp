	...
	$(function() {	
	    ...
	    $('#dataList').datagrid({ 
	        ...
	        columns: [[  
				{field:'chk',checkbox: true,width:50},
 		        ...
 		        {field:'info',title:'项目介绍',width:100, 
 		        },
	 		]], 
	        toolbar: "#toolbar"
	    }); 
	    ...
	    $("#delete").click(function(){
        	...
        	if(selectRow == null){
            	...
            	$.messager.confirm("消息提醒", "将删除项目信息（如果项目下存在会员或教练则不能删除），确认继续？", function(r){
            		if(r){
            			$.ajax({
							type: "post",
...
<body>
	...
	<div id="toolbar">
		...
		<div style="margin-top: 3px;">健身项目名称：<input id="clazzName" class="easyui-textbox" name="clazzName" />
