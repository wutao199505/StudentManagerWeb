	...
	$(function() {	
	    ...
	    $('#dataList').datagrid({ 
	        ...
	        columns: [[  
				{field:'chk',checkbox: true,width:50},
 		        ...
 		        {field:'sn',title:'卡号',width:200, sortable: true},    
 		        {field:'name',title:'姓名',width:200},
 		        {field:'sex',title:'性别',width:100},
 		        {field:'mobile',title:'电话',width:150},
 		        {field:'qq',title:'QQ',width:150},
 		        {field:'clazz_id',title:'会员等级',width:150, 
	    ...
	    $("#delete").click(function(){
        	...
        	if(selectLength == 0){
            	...
            	$.messager.confirm("消息提醒", "将删除与会员相关的所有数据(包括成绩)，确认继续？", function(r){
            		if(r){
            			$.ajax({
							type: "post",
...
<body>
	...
	<div id="toolbar">
		...
		<div style="margin-left: 10px;margin-top:4px;" >健身项目：<input id="clazzList" class="easyui-textbox" name="clazz" />
