...
<head>
    ...
    <script type="text/javascript">
	 var _menus = {"menus":[
						...
						{"menuid":"2","icon":"","menuname":"会员信息管理",
							"menus":[
									{"menuid":"21","menuname":"会员列表","icon":"icon-user-student","url":"StudentServlet?method=toStudentListView"},
								]
						},
						<c:if test="${userType == 1 || userType == 3}">
						{"menuid":"4","icon":"","menuname":"健身信息管理",
							"menus":[
									{"menuid":"42","menuname":"会员等级","icon":"icon-house","url":"ClazzServlet?method=toClazzListView"}
								]
						},
						</c:if>
						<c:if test="${userType == 1 || userType == 3}">
						{"menuid":"3","icon":"","menuname":"教练信息管理",
							"menus":[
									{"menuid":"31","menuname":"教练列表","icon":"icon-user-teacher","url":"TeacherServlet?method=toTeacherListView"},
								]
						},
						</c:if>
						<c:if test="${userType == 1 || userType == 3}">
						{"menuid":"6","icon":"","menuname":"健身项目信息管理",
							"menus":[
									{"menuid":"61","menuname":"项目列表","icon":"icon-book-open","url":"CourseServlet?method=toCourseListView"},
								]
						},
						</c:if>
						{"menuid":"7","icon":"","menuname":"选择健身信息管理",
							"menus":[
									{"menuid":"71","menuname":"会员选择健身项目列表","icon":"icon-book-open","url":"SelectedCourseServlet?method=toSelectedCourseListView"},
								]
						},
...
<body class="easyui-layout" style="overflow-y: hidden"  scroll="no">
    ...
    <div region="north" split="true" border="false" style="overflow: hidden; height: 30px;
        ...
        <span style="padding-left:10px; font-size: 16px; ">健身房会员管理系统</span>
    </div>
